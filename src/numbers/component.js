    ...
    <div>
      <form className="Form">
        ...
        <select name="category" autoFocus="true" onChange={ onSearchFieldFilled }>
          ...
          <option value="Pain">Quit Smoking</option>
          ...
          <option value="Pain">Security</option>
          <option value="Pain">Smoking Cessation</option>
          <option value="Pain">Sporting Goods</option>
          <option value="Pain">Sports</option>
          <option value="Pain">Swimming Pool</option>
          <option value="Pain">Taxis</option>
          <option value="Pain">Telephone</option>
          <option value="Pain">Trailers</option>
          <option value="Pain">Travel</option>
          <option value="Pain">Vet</option>
          <option value="Pain">Vision</option>
          <option value="Pain">Weight Loss</option>
          <option value="Pain">Wood Sales</option>
        </select>
